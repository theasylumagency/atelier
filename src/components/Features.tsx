            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 transition-transform duration-500">
                ...
                <div className="grid grid-cols-12 gap-8 mb-32">
                    <div className="col-span-12 lg:col-span-7 pt-12">
                        <Link href={panelHref} className="group block cursor-pointer">
                            <span className="text-orange-600 font-mono font-bold text-[10px] uppercase tracking-[0.4em] block mb-6 px-1 pr-10 inline-block">
                                {dict.features.chapter}
                            </span>
                            <h2 className="font-serif text-6xl md:text-8xl font-light leading-[0.9] tracking-tighter mb-8 text-slate-900 group-hover:opacity-80 transition-opacity">
                                {dict.features.title_prefix} <br />
                            ...
                            <p className="text-xl md:text-2xl text-slate-600 font-light leading-relaxed max-w-xl group-hover:text-slate-800 transition-colors">
                                {dict.features.desc}
                            </p>
                        </Link>
                    </div>
                    <div className="col-span-12 lg:col-span-5 flex items-end justify-end">
                        <Link href={panelHref} className="block group cursor-pointer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24 mb-40">
                    ...
                    <div className="md:col-span-8 grid grid-cols-2 gap-4">
                        <Link href={panelHref} className="col-span-2 md:col-span-2 aspect-[21/9] bg-slate-100 relative overflow-hidden group border border-slate-200/50 cursor-pointer block">
                            <div className="absolute inset-0 bg-gradient-to-tr from-orange-600/10 to-transparent z-10 transition-opacity duration-700 group-hover:opacity-50"></div>
                ...
                <div className="border-y border-slate-200 py-16 grid grid-cols-1 md:grid-cols-3 gap-12 relative overflow-hidden">
                    <Link href={panelHref} className="relative z-10 group block cursor-pointer transform transition-all duration-300 hover:-translate-y-1 hover:bg-slate-50 p-4 -m-4 rounded-xl">
